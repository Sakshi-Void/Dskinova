...
import { skinMenu } from "../data/menuData.js";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          ...
          <div className="order-2 lg:order-1">
            <div className="space-y-8 max-w-xl mx-auto lg:max-w-none lg:mx-0">
              ...
              {/* Services List (synced with header skin services) */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {skinMenu.slice(0, 6).map((svc, idx) => (
                  <div
                    key={svc.label + idx}
                    className="flex items-center gap-3"
                  >
                    <div className="w-2 h-2 bg-orange-400 rounded-full"></div>
                    <span className="text-gray-600 text-sm">{svc.label}</span>
                  </div>
                ))}
              </div>
